...
scriptdir = '/var/www/Phylab/storage/app/script/' if platform.system(
) == 'Linux' else 'C:/Users/CFREE/Documents/Github/auto-deploy-phylab/Phylab/storage/app/script/'
...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            # raise e
            pass
        latex_body = __import__(
            'p' + sys.argv[1]).handler(root)  # (sys.argv[2])
        ...
        # 等于１时是错误
        ret = subprocess.call(
            "xelatex -interaction=nonstopmode " + sys.argv[3] + ".tex", shell=True)

...
d_list_1 = []  # 10 4 2 1 -1 -2 -4 -10
d_list_2 = []  # 10 4 2 1 -1 -2 -4 -10
average_d_list = []  # 10 4 2 1 -1 -2 -4 -10
d_list = []  # 10 4 2 1
f_list = []  # 10 4 2 1
u_f_list = []  # 10 4 2 1
...
def niconiconi():
    ...
    for i in range(4):
        d_list.append(abs(average_d_list[0 + i] - average_d_list[7 - i]))
    k = [10, 4, 2, 1]
    for i in range(4):
...
if __name__ == '__main__':
    dom = xml.dom.minidom.parse(scriptdir+'test/1060513test/1060513.xml')

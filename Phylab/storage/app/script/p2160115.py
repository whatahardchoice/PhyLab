...
def process_data(u , t  , source , name):
    ...
    return env.from_string(source).render(
        U = u,
      	...
      	ave_t4 = ave_t[4],
      	ave_t5 = ave_t[5],
        q0 = phylab.ToScience(q[0]),
      	n0 = n[0],
      	e0 = phylab.ToScience(e[0]),
      	eta0 = eta[0],
      	q1 = phylab.ToScience(q[1]),
      	n1 = n[1],
      	e1 = phylab.ToScience(e[1]),
      	eta1 = eta[1],
      	q2 = phylab.ToScience(q[2]),
      	n2 = n[2],
      	e2 = phylab.ToScience(e[2]),
      	eta2 = eta[2],
      	q3 = phylab.ToScience(q[3]),
      	n3 = n[3],
      	e3 = phylab.ToScience(e[3]),
      	eta3 = eta[3],
      	q4 = phylab.ToScience(q[4]),
      	n4 = n[4],
      	e4 = phylab.ToScience(e[4]),
      	eta4 = eta[4],
      	q5 = phylab.ToScience(q[5]),
      	n5 = n[5],
      	e5 = phylab.ToScience(e[5]),
      	eta5 = eta[5],
      	eta = phylab.ToScience(eta_f),
      	ave_e = phylab.ToScience(ave_e),
      	U_a = phylab.ToScience(ua),
      	figurename = pic
    )

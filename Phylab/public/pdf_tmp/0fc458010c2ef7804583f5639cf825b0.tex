...
\begin{enumerate}
  ...
  \item {不确定度的计算}
      ...
      $$\therefore{\theta}_{\gamma} \pm u({\theta}_{\gamma}) = ()rad$$
...
\begin{enumerate}
  ...
  \item {不确定度的计算}
      ...
      $$\therefore{\theta}_p \pm u({\theta}_p) = ()rad$$
  ...
  \item{加权平均求$R_H$的最佳值}
      ...
      $$\therefore\text{最佳测量值 \ } \overline{R_H} \pm u(\overline{R_H}) = () m^{-1}$$   
\end{enumerate}

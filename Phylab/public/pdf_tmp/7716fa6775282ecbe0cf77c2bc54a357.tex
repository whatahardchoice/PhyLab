...
$$\overline{ {\theta}_2} = \displaystyle\frac12\ \overline{2{\theta}_2} = 0.3608$$
...
\begin{enumerate}
  \item $\pm1$级d的不确定度
    ...
    $$\therefore \ u(d) = \displaystyle d\ \frac{u(d)}{d} = 0.004254\mu m $$
  \item $\pm2$级d的不确定度
...
\subsubsection*{(4)测量结果加权平均求d最佳值}
  测量结果： $$d \pm u(d) = (3.337 \pm 0.004254)\mu m $$
  $$d' \pm u(d') = (3.338 \pm 0.0007428)\mu m $$
  ...
  $$\therefore\text{光栅常数d的最终表达式为\ }\overline{d} \pm u(\overline{d}) = (3.338 \pm 7.3{\times}10^{-4})\mu m $$
...
\begin{enumerate}
  ...
  \item {不确定度的计算}
      ...
      $$R_{H_1} \pm u(R_{H_1}) = (9010828.698089 \pm 8.39337918{\times}10^{5})m^{-1}$$
\end{enumerate}
